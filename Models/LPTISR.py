...
class LPTISR(nn.Module):
    def __init__(self, scale, n_frames=7, is_training=False):
        super(LPTISR, self).__init__()
        self.scale = scale
        self.is_training = is_training
        self.OFR = OFRnet(scale=scale, channels=64)
        self.SR = LargePNet(4*n_frames-3, n_frames, 2, 15, 4)
